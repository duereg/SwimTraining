...
var Timeline = function(container, date) { 
	...
	this.setupPlaceHolders = function() {
		var arrows = $("<div>").addClass("timeline_arrows");
		var top = $("<div>").addClass("timeline_top").append("<ul></ul>");
		var bottom = $("<div>").addClass("timeline_bottom").append("<ul></ul>");

		this.container.append([arrows, top, bottom]);
		return {
			arrows: arrows,
	...
	this.getNumberOfDaysInMonth = function(dateObject) {
		return new Date(dateObject.getYear(), 
